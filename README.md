...
### Skills: Data exploration, descriptive statistics, logical reasoning.
Dataset: Students Performance in Exams Dataset (CSV)
...
#### Deliverable: Short report describing the dataset’s size, centre, spread, shape, and group differences.
